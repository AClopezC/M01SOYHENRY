...
function cacheFunction(cb) {
  const cacheContador = {};
return function (arg) {
  if (cacheContador.hasOwnProperty(arg)) {
    return cacheContador[arg];
  }
  cacheContador[arg] = cb(arg) // aquí es un else, ya que al no cumplirse la condición previa salta a la siguiente línea.
  return cacheContador[arg]
}
}

//Lo siguiente hace parte del ejercicio anterior y sirve para corroborar el ejercicio.
  function square(n){
    return n * n
  }
const squareCache = cacheFunction(square)
...
let textoUnderscore = crearCadena.bind(this, "_", "_");
 ...
 // Ya que this no es relevante dentro de la función, aquí se podía poner true, false y null, (casi cualquier cosa) solo ocupan un espacio.
